...
* Passer, accéder et afficher les accessoires.
* Utilisez des accessoires pour créer des instructions conditionnelles.
...
* Attribuez des valeurs par défaut aux accessoires.
